...
fun AriAiAppNavigation(viewModel: AppViewModel) {
    ...
    val bottomNavRoutes = listOf("home", "chats", "tools", "providers", "settings")
    ...
    Scaffold(
        bottomBar = {
            if (showBottomBar) {
                NavigationBar(
                    containerColor = if (currentRoute == "tools") Color(0xFFF5F7FF) else Color(0xFF0F0F2A),
                    contentColor = if (currentRoute == "tools") Color.Black else Color.White
                ) {
                    NavigationBarItem(
                    ...
                    NavigationBarItem(
                        ...
                        label = { Text("Tools", fontWeight = if (currentRoute == "tools") FontWeight.Bold else FontWeight.Normal) },
